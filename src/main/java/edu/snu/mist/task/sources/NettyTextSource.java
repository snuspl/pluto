 ...
 */
final class NettyTextSource implements Source<String> {
  ...
  NettyTextSource(final String queryId,
  ...
  public void start() {
    if (started.compareAndSet(false, true)) {
      if (outputEmitter != null) {
        ...
        final ChannelFuture channelFuture = clientBootstrap.connect(serverSocketAddress);
