 ...
 */
public final class ClientToTaskSpecificResponderWrapper implements ExternalConstructor<SpecificResponder> {
  ...
  @Inject
  private ClientToTaskSpecificResponderWrapper(final ClientToTaskMessage clientToTaskMessage) {
