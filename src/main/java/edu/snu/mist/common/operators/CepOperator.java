...
public final class CepOperator<T> extends OneStreamOperator {
    ...
    /**
     * Class for saving matched pattern. To discard timeout pattern, it includes the first event time.
     * @param <T> user-defined class
     */
    private final class EventStack<T> {
         ...
         */
        private EventStack<T> copyStack() {
     ...
     * @param <T> user-defined class
     */
    private final class EventStackEntry<T> {
        /**
        ...
        /**
         * Check whether stop condition is triggered.
         */
        private boolean isStoped;

        private EventStackEntry(final int index) {
            this.index = index;
        ...
        private void setList(final List<T> eventListParam) {
            events.clear();
            events.addAll(eventListParam);
        }

        private void addEvent(final T event) {
         ...
         */
        private EventStackEntry<T> copyEntry() {
