 ...
 */
public final class WeightedRRNextGroupSelectorFactory implements NextGroupSelectorFactory {
  ...
  @Inject
  private WeightedRRNextGroupSelectorFactory(final MistPubSubEventHandler mistPubSubEventHandler,
  ...
  public NextGroupSelector newInstance() {
    return new WeightedRRNextGroupSelector(mistPubSubEventHandler, globalSchedGroupInfoMap);
  }
}