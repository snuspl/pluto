 ...
 */
public final class RuleBasedMapToStringFunction implements MISTFunction<Map<String, Object>, String> {
    private final List<Object> fields;
    private final String separator;

    public RuleBasedMapToStringFunction(final List<Object> fieldsParam, final String separatorParam) {
    ...
    public boolean equals(final Object o) {
        ...
        final RuleBasedMapToStringFunction that = (RuleBasedMapToStringFunction) o;
    ...
    public String apply(final Map<String, Object> s) {
        ...
        if (strBuilder.length() == 0) {
            throw new NullPointerException("No Parameters for rule-based Sink!");
        }
