 ...
 */
public final class CepORPredicate implements MISTPredicate<Map<String, Object>> {

    private final List<MISTPredicate<Map<String, Object>>> predicateList;

    public CepORPredicate(final List<MISTPredicate<Map<String, Object>>> predicateList) {
