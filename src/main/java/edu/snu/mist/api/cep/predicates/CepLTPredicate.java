 ...
 */
public final class CepLTPredicate extends CepCCPredicate implements MISTPredicate<Map<String, Object>> {

    public CepLTPredicate(final String field, final Object value) {
        super(field, value);
    }
