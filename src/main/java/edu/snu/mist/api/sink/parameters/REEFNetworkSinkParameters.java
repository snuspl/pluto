...
/**
 * This class contains the list of necessary parameters for REEFNetworkSinkConfigurations.
 */
public final class REEFNetworkSinkParameters {

  private REEFNetworkSinkParameters() {
    // not called.
  }
