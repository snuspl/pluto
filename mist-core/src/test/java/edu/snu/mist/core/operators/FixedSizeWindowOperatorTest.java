...
import edu.snu.mist.core.operators.window.CountWindowOperator;
import edu.snu.mist.core.operators.window.TimeWindowOperator;
...
public final class FixedSizeWindowOperatorTest {
  ...
  public void testSlidingTimeWindowOperator() throws InterruptedException {
    ...
    OperatorTestUtils.checkWindowData(
        result.get(0), expectedResult1, d1.getTimestamp(), emissionInterval, d1.getTimestamp());
    ...
    OperatorTestUtils.checkWindowData(
        result.get(1), expectedResult2, d1.getTimestamp(), windowSize, d2.getTimestamp());
  ...
  public void testTimeWindowOperatorSetState() throws InterruptedException {
    ...
    OperatorTestUtils.checkWindowData(
        result.get(0), expectedResult1, d4.getTimestamp(), emissionInterval, w2.getTimestamp());
  ...
  public void testHoppingCountWindowOperator() throws InterruptedException {
    ...
    OperatorTestUtils.checkWindowData(
        result.get(2), expectedResult2, emissionInterval + 1L, windowSize, d8.getTimestamp());
