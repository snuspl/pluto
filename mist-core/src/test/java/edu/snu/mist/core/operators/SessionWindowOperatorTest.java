...
import edu.snu.mist.core.operators.window.SessionWindowOperator;
...
public final class SessionWindowOperatorTest {
  ...
  public void testSessionWindowOperator() throws InterruptedException {
    ...
    OperatorTestUtils.checkWindowData(result.get(0), expectedResult1, d1.getTimestamp(),
    ...
    OperatorTestUtils.checkWindowData(result.get(2), expectedResult2, d3.getTimestamp(),
  ...
  public void testSessionWindowOperatorSetState() throws InterruptedException {
    ...
    OperatorTestUtils.checkWindowData(result.get(0), expectedResult, d5.getTimestamp(),
