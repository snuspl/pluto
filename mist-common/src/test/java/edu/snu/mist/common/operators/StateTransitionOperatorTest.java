...
import edu.snu.mist.common.operators.predicates.RuleBasedEQPredicate;
...
public class StateTransitionOperatorTest {
    ...
    public void testStateTransitionOperator() throws InterruptedException {
        ...
        Assert.assertEquals("1",
                stateTransitionOperator.getCurrentOperatorState().get("stateTransitionOperatorState"));
    ...
    public void testStateTransitionOperatorGetState() throws InterruptedException {
        ...
        //Get the
        final Map<String, Object> operatorState = stateTransitionOperator.getCurrentOperatorState();
