...
public final class ReduceByKeyOperatorTest {
  ...
  public void testReduceByKeyOperatorGetState() throws InterruptedException {
    ...
    final Map<String, Object> operatorStateMap = wcOperator.getCurrentOperatorState();
  ...
  public void testReduceByKeyOperatorSetState() throws InterruptedException {
    ...
    final Map<String, Object> operatorStateMap = reduceByKeyOperator.getCurrentOperatorState();
