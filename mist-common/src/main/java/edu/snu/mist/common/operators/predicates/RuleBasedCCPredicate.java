...
package edu.snu.mist.common.operators.predicates;
...
/**
 * Abstract class for filtering rule-based Comparison Condition.
 */
public abstract class RuleBasedCCPredicate implements MISTPredicate<Map<String, Object>> {
    private final String field;
    private final Object value;

    public RuleBasedCCPredicate(final String field, final Object value) {
        this.field = field;
        this.value = value;
    }
     ...
     */
    public int ruleBasedCompare(final Object eventObj, final Object queryObj) {
    ...
    public boolean equals(final Object o) {
        ...
        final RuleBasedCCPredicate that = (RuleBasedCCPredicate) o;
